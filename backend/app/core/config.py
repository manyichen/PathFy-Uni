...
class Config:
    ...
    MATCH_DEEPSEEK_MODEL = os.getenv("MATCH_DEEPSEEK_MODEL", "deepseek-v4-flash")
    MATCH_LLM_TIMEOUT_SECONDS = float(os.getenv("MATCH_LLM_TIMEOUT_SECONDS", "120"))

    CAREER_DEEPSEEK_MODEL = os.getenv("CAREER_DEEPSEEK_MODEL", "deepseek-v4-pro")
    ...
    GRAPH_WORKER_LEASE_SECONDS = max(15, int(os.getenv("GRAPH_WORKER_LEASE_SECONDS", "60")))
    GRAPH_WORKER_MAX_ATTEMPTS = max(1, int(os.getenv("GRAPH_WORKER_MAX_ATTEMPTS", "3")))
    GRAPH_WORKER_RETRY_BASE_SECONDS = max(1, int(os.getenv("GRAPH_WORKER_RETRY_BASE_SECONDS", "5")))
    GRAPH_CAP_VERSION = os.getenv("GRAPH_CAP_VERSION", "job-cap-v2")
    GRAPH_CAP_REVIEW_CONFIDENCE_THRESHOLD = float(os.getenv("GRAPH_CAP_REVIEW_CONFIDENCE_THRESHOLD", "0.60"))
    GRAPH_CAP_PRIMARY_PROVIDER = os.getenv("GRAPH_CAP_PRIMARY_PROVIDER", "deepseek")
    GRAPH_CAP_PRIMARY_MODEL = os.getenv("GRAPH_CAP_PRIMARY_MODEL", "deepseek-v4-flash")
    GRAPH_CAP_PRIMARY_BASE_URL = os.getenv("GRAPH_CAP_PRIMARY_BASE_URL", "https://api.deepseek.com")
    GRAPH_CAP_REVIEW_PROVIDER = os.getenv("GRAPH_CAP_REVIEW_PROVIDER", "qwen")
    GRAPH_CAP_REVIEW_MODEL = os.getenv("GRAPH_CAP_REVIEW_MODEL", "qwen3.6-plus")
    GRAPH_CAP_REVIEW_BASE_URL = os.getenv("GRAPH_CAP_REVIEW_BASE_URL", "https://dashscope.aliyuncs.com/compatible-mode/v1")
    GRAPH_CAP_LLM_TIMEOUT_SECONDS = float(os.getenv("GRAPH_CAP_LLM_TIMEOUT_SECONDS", "180"))
    GRAPH_CAP_MAX_RETRIES = int(os.getenv("GRAPH_CAP_MAX_RETRIES", "3"))
