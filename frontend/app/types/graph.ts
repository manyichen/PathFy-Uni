export const graphTaskCatalog = {
  ...
  job_workstyle_import: { label: '岗位工作环境画像导入', category: '岗位与能力', icon: 'i-lucide-panels-top-left', file: true },
  job_workstyle_evaluation: { label: '存量岗位工作环境评估', category: '岗位与能力', icon: 'i-lucide-scan-text', file: false },
...
export const summaryLabels: Record<string, string> = {
  ...
  affected_relationships: '影响关系', scope: '评估范围', source_id: '数据来源', snapshot_prune: '来源快照清理', workstyle_ready: '环境解释就绪'
}
